...
export const COMPONENT_META: Record<Component, { title: string; weight: number; tip: string; color: string }> = {
  guvenlik: { title: 'Güvenlik', weight: 0.3, tip: 'Çarpışma, ramak kala, takip mesafesi, sert olaylar', color: '#ef5350' },
  kural: { title: 'Kural uyumu', weight: 0.25, tip: 'Hız, ışık, dur/yol ver, sinyal, yön, yaya önceliği', color: '#ffa726' },
  tarama: { title: 'Tarama', weight: 0.2, tip: 'Ayna / omuz kontrolü, dikiz sıklığı, kavşak taraması', color: '#42a5f5' },
  puruzsuzluk: { title: 'Pürüzsüzlük', weight: 0.15, tip: 'Sarsıntı (jerk), ivme, yanal g, direksiyon düzeltmeleri', color: '#66bb6a' },
  gorev: { title: 'Görev', weight: 0.1, tip: 'Hedefler, rota uyumu, zaman', color: '#ab47bc' },
};
...
export const EVENT_META: Record<EventKind, { label: string; component: Component; severity: Severity }> = {
  ...
  yield_fail: { label: 'Geçiş önceliğine uymama', component: 'kural', severity: 'major' },
